...
class AddProjectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addprj_add.setOnClickListener {
            ...
            if (prjname_add.text.toString().equals("") || input_add.text.toString().equals("") || edit_desc_add.text.toString().equals("")) {
                ...
                if (!prj_dept_add.text.toString().equals("dept")) {
                    ...
                    val intent1 =
                        Intent(this@AddProjectActivity, RecommendationActivity::class.java)
